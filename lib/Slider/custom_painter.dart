 ...
 */
    ...
    print('This is the painter refresh############################');

    Paint leftprogress = _getPaint(color: selectionLeftColor, width: 27);
    Paint rightprogress = _getPaint(color: selectionRightColor, width: 27);
  ...
  @override
  bool shouldRepaint(CustomLeftRightSlider oldDelegate) {
    return true;
  }
}
