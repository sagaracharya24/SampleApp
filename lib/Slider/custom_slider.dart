...
import 'package:sampleApp/Slider/base_painter.dart';
import 'package:sampleApp/Slider/custom_painter.dart';
import 'package:sampleApp/utils.dart';

typedef void Callback(int leftValue, int rightValue);
...
class CustomSlider extends StatefulWidget {
  ...
  CustomSlider({key, this.leftValue, this.rightValue, this.callback})
      : super(key: key);
...
class _CustomSliderState extends State<CustomSlider> {
  ...
  void initState() {
    super.initState();
    leftEnd = widget.leftValue;
    rightEnd = widget.rightValue;

    print('This is the start change!!!!!!!!!!!!!!!!!!!');
    print(widget.leftValue);
  }

  changeValues(int left, int right) {
    setState(() {
      leftEnd = left;
      rightEnd = right;
    });
  ...
  Widget build(BuildContext context) {
    print('this is the value ${widget.leftValue}*************** $leftEnd');
    print(
        'this is the right value ${widget.rightValue}*************** $rightEnd');
    ...
    return Scaffold(
      ...
      body: SliderPaintt(
        ...
        onSelectionChange: (int left, int right) {
          ...
          widget.callback(leftEnd, rightEnd);
        },
        child: Container(
          child: Center(
              child: Row(
...
// we need to update this widget both with gesture detector but
  ...
  _onPanDown(DragDownDetails details) {
    print('This is the percent on tapdown');
